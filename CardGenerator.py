...
class CardGenerator:
    ...
    def get_card_details(self, name, number, set_total=None, promo=False):
        ...
        return {"name":name, "number":number, "set_total":set_total, "super_type":super_type, "card_type":card_type, "sub_type":sub_type, "image_url":image_url, "image_path":image_path}
